...
type: resource
source: zhihu
url: https://zhuanlan.zhihu.com/p/616157476
topics: [AI, 语言, 英语, 投资, 出行, 旅行]
status: processed
para: resource
tags: []
created: 2026-02-02
...
---
# 推荐：ChatGPT指令大全（37个！）
[内容链接](https://zhuanlan.zhihu.com/p/616157476)

![图片描述](https://pic1.zhimg.com/v2-5ee74a8f895fa75b109c514ae0d82230_r.jpg)

使用时，可参考这些语境。会问问题，才是最重要的。

[AGI 时代必备：《提问的艺术——让ChatGPT导出高质量答案》](https://zhuanlan.zhihu.com/p/615702056)
...
11. 写代码：你现在是一个 [程序语言] 专家，请帮我用 [程序语言] 写一个函式，它需要做到 [某个功能]。

12. 解释代码：你现在是一个 [程序语言] 专家，请告诉我以下的程序在做什么。[附上程序]。

13. 重构代码：你现在是一个 Clean Code 专家，我有以下的程序，请用更干净简洁的方式改写，让我的同事们可以更容易维护程序。另外，也解释为什么你要这样重构，让我能把重构的方式的说明加到 Pull Request 当中。[附上程序]。

14. 解BUG：你现在是一个 [程序语言] 专家，我有一段程序，我预期这段程序可以 [做到某个功能]，只是它通过不了 [测试案例] 这个测试案例。请帮我找出我哪里写错了，以及用正确的方式改写。[附上程序]

15. 写测试：你现在是一个 [程序语言] 专家，我有一段程序 [附上程序]，请帮我写一个测试，请至少提供五个测试案例，同时要包含到极端的状况，让我能够确定这段程序的输出是正确的。
...
21. 背单词辅助：用 [中文/英文] 解释以下英文单字：[填入一个或多个单字]。请用表格的方式呈现，并且表格内须包含单字、词性、解释与例句。
...
32. 路由计划：生成一份 [数字] 天的 [地点] 旅游计划，交通工具是 [交通工具...]。要遵守以下规则：[填入规则]
...
36. 模拟面试：你现在是一个 [职位] 面试官，而我是要应征 [职位] 的面试者。你需要遵守以下规则：1. 你只能问我有关 [职位] 的面试问题。2. 不需要写解释。3. 你需要向面试官一样等我回答问题，再提问下一个问题。我的第一句话是，你好。
