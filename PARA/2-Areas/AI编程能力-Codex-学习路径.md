...
1. [[AI编程能力-Codex-MCP模型上下文协议]]
2. [[AI编程能力-Codex-用AgentsSDK构建一致工作流]]

### 2) 把 Codex 放进 CI (自动化落地)

3. [[../3-Resources/AI编程能力-Codex-GitHubActionsCI失败自动修复]]
4. [[../3-Resources/AI编程能力-Codex-GitLabCI代码质量与安全修复]]
5. [[AI编程能力-CI-中的代码审查-Codex-结构化输出]]
6. [[../3-Resources/AI编程能力-Codex-Jira与GitHub自动化从工单开PR]]

### 3) 处理长任务 (规划与现代化)

7. [[AI编程能力-Codex-用PLANSmd拆解多小时任务]]
8. [[AI编程能力-Codex-代码库现代化]]
